...
namespace Sanduba.Tests.Core.Application.Payments
{
    public class PaymentInteractorTest
    {
        ...
        {
            // Arrange
            var requestModel = PaymentFixtures.InvalidPaymentCreationRequestModel();
            ...
            Assert.Equal("Error during payment creation", response.Message);
        }
        ...
        public void UpdatePayment_ValidRequest_UpdatesPayment()
        {
            ...
            var payment = PaymentFixtures.PaymentSentToProvider(Guid.NewGuid());
        ...
        public void GetPaymentById_ExistingId_ReturnsPayment()
        {
            ...
            var payment = PaymentFixtures.PaymentCreated(paymentId);
